...
export const MESSAGE_TYPES = [
  ...
  },
  {
    ...
    selector: '.notice:not(.pm), .adminnotice, .bloody, .shitty, .infobox, .info, .largeinfo, .sinister, .cult, .infoplain, .announce, .hear, .smallnotice, .holoparasite, .bling, .achievementrare, .achievementgood, .achievementneutral, .achievementbad',
  },
  {
